...
const PlayVideo = () => {
  ...
  return (
    <div className="play-video">
      ...
      <h3>{apiData ? apiData.snippet.title : "The Title is here."}</h3>
      <div className="play-video-info">
        <p>
          {apiData ? valueConverter(apiData.statistics.viewCount) : "10K"}{" "}
          &bull; {apiData ? moment(apiData.snippet.publishedAt).fromNow() : ""}{" "}
        </p>
        <div>
          <span>
            <img src={like} alt="" />
            {apiData ? valueConverter(apiData.statistics.likeCount) : "102"}
          </span>
          <span>
            <img src={dislike} alt="" />
          </span>
      ...
      <div className="vid-discription">
        ...
        <p>
          Subscribe the GreatStack to Watch More Tutorials on Web development
        </p>
        <hr />
        <h4>
          {apiData ? valueConverter(apiData.statistics.commentCount) : "105"}{" "}
          Comments
        </h4>
